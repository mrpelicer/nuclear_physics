...
set rmargin 20
set key at 3.9e18,0.6 Left spacing 2.

parameter="l3wr"

#Plot	1
plot  "../data/dens_beta_".parameter."_wtB.txt"   	u 1:3  w l lw 10 dt 2 lc rgb "#00ff99"   title "p" ,\
			"../data/dens_beta_".parameter."_wtB.txt"  		u 1:2  w l lw 10 dt 2 lc rgb "#ffcc00"   title "n" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:4  w l lw 10 dt 2 lc rgb "#0066cc"   title "e" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:5  w l lw 10 dt 2 lc rgb "#660066"   title "$\\mu$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:6  w l lw 10 dt 2 lc rgb "#33cccc"   title "$\\Lambda^0$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:7  w l lw 10 dt 2 lc rgb "#6600ff"   title "$\\Sigma^+$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:8  w l lw 10 dt 2 lc rgb "#bf00ff"   title "$\\Sigma^0$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:9  w l lw 10 dt 2 lc rgb "#ff9933"   title "$\\Sigma^-$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:10 w l lw 10 dt 2 lc rgb "#00cc00"   title "$\\Xi^0$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:11 w l lw 10 dt 2 lc rgb "#ff3300"   title "$\\Xi^-$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:12 w l lw 10 dt 2 lc rgb "#993333"   title "$\\Delta^{++}$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:13 w l lw 10 dt 2 lc rgb "#ff66cc"   title "$\\Delta^+$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:14 w l lw 10 dt 2 lc rgb "#006600"   title "$\\Delta^0$" ,\
			"../data/dens_beta_".parameter."_wtB.txt"   	u 1:15 w l lw 10 dt 2 lc rgb "#000000"   title "$\\Delta^-$" ,\
			 "../data/dens_beta_".parameter."_wtA.txt"   	u 1:3  w l lw 10 dt 1 lc rgb "#00ff99"   notitle ,\
			 "../data/dens_beta_".parameter."_wtA.txt"  	u 1:2  w l lw 10 dt 1 lc rgb "#ffcc00"   notitle ,\
