...
//Set system variables
  ...
  double dRho=  (rhoBMax-rhoBMin)/iR;
	...
	filename1="data/diagram_H_" +parametrization+
												"_B"+to_string(pow(Bag, 1/4.)*Mnucleon)+"_noYe.txt";
  ...
  //  for (double temperature : tempv){
      ...
      + PressureQ)/quarks.rhoB;
			...
			// quarks.muB= Yu* quarks.qu.chemPot + Yd*quarks.qd.chemPot+  Ys*quarks.qs.chemPot
			// 						+ (electron.chemPot*electron.density +muon.chemPot*muon.density)/quarks.rhoB;
